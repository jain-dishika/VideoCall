  ...
  return (
    <div className='vcs2-meeting-info-block'>
        <div className="vcs2-meeting-header">
            ...
            <i className="fa-solid fa-xmark vcs2-icon" onClick={()=> {setMeetInfoPopup(false);}}/>
        </div>
        <div className="vcs2-meet-link">
          <span>{peerId}</span>
          <i className="fa-solid fa-copy vcs2-icon" onClick={()=> navigator.clipboard.writeText(peerId)}></i>
        </div>
